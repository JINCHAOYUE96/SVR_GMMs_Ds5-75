...
raw_data = pd.read_csv(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_D70\D70\DataD702.csv',encoding='GBK')
...
data_df_xunlian.columns=['D70','zh']
data_xunlian=pd.DataFrame(X_train)
data_xunlian.columns=['ln_distance','M','ln_Vs30']
writer_xunlian=pd.ExcelWriter(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_D70\D70\train.xls')
...
data_df_ceshi.columns=['D70','zh']
data_ceshi=pd.DataFrame(X_test)
data_ceshi.columns=['ln_distance','M','ln_Vs30']
writer_ceshi=pd.ExcelWriter(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_D70\D70\test.xls')
...
model_svr = SVR(kernel="rbf",gamma=0.279,C=3.404,epsilon=0.061) # Set the hyperparameters of SVR GMMs
model_names = ['SVR']
model_dic = [model_svr]
cv_score_list = []
pre_y_list = []
...
new_pre_SVR_y = []
raw_data = pd.read_csv(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_D70\D70\shujv2222-11.csv',encoding='GBK') # input the information for prediction (R,M,Vs30)
